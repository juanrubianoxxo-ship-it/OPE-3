...
```toml
ONEDRIVE_OPERACIONES_URL = "https://1drv.ms/..."
```

También se acepta la variable de entorno `ONEDRIVE_OPERACIONES_URL`. Una vez configurado, la barra lateral solo muestra el botón **Actualizar desde OneDrive**; el vínculo permanece oculto. El vínculo debe permitir descargar el archivo `.xlsm` y conservar la hoja `Visitas_Operaciones`.
